...
class TestCase extends Orchestra
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        $app['config']->set('subby', [
            ...
            'models' => [
                ...
                'plan_subscription' => \Bpuig\SubbySchedule\Tests\Models\PlanSubscription::class,
        ...
        $app['config']->set('subby.schedule', [
            ...
            'services' => [
                'success' => \Bpuig\SubbySchedule\Tests\Services\SuccessScheduleService::class,
                'fail' => \Bpuig\SubbySchedule\Tests\Services\FailedScheduleService::class
            ]
        ]);
    ...
    {
        return [SubbyScheduleServiceProvider::class];
    }
    ...
    protected function setUpDatabase()
    {
        ...
        include_once __DIR__ . '/../../laravel-subby/tests/Database/migrations/create_users_table.php.stub';
        include_once __DIR__ . '/../../laravel-subby/database/migrations/create_plans_table.php.stub';
        include_once __DIR__ . '/../../laravel-subby/database/migrations/create_plan_features_table.php.stub';
        include_once __DIR__ . '/../../laravel-subby/database/migrations/create_plan_subscriptions_table.php.stub';
        include_once __DIR__ . '/../../laravel-subby/database/migrations/create_plan_subscription_features_table.php.stub';
        include_once __DIR__ . '/../../laravel-subby/database/migrations/create_plan_subscription_usage_table.php.stub';
